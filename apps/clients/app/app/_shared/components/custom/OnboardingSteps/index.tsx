					...
					<div className="space-y-3">
						<div className="flex items-center gap-3 p-4 rounded-lg border border-gray-300">
							...
							<div className="flex-1">
								<p
									className={`font-medium ${completedTasks.monitor ? 'line-through text-muted-foreground' : ''}`}
								>
						...
						<div className="flex items-center gap-3 p-4 rounded-lg border border-gray-300">
							...
							<div className="flex-1">
								<p
									className={`font-medium ${completedTasks.billing ? 'line-through text-muted-foreground' : ''}`}
								>
