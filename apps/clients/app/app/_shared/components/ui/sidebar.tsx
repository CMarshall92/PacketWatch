...
function SidebarProvider({
	...
	const toggleIsOpen = useSidenav((state) => state.toggleIsOpen)

	// This is the internal state of the sidebar.
	// We use openProp and setOpenProp for control from outside the component.
	const defaultOpen = useSidenav((state) => state.isOpen)
	const [_open, _setOpen] = React.useState<boolean>(defaultOpen)
	const open = openProp || _open

	React.useEffect(() => {
		const stored = localStorage.getItem('sidenav_isOpen')
		_setOpen(stored === 'true')
		toggleIsOpen(stored === 'true')
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			localStorage.setItem('sidenav_isOpen', String(openState))
