		...
		data: [
			{
				...
				label: 'Google',
				isApi: false,
				icon: 'https://icon2.cleanpng.com/20180330/jjq/avc3ltutu.webp',
			},
			{
				slug: '3in2jnk2ff',
				href: 'https://www.cmarshall.io',
				label: 'Cmarshall',
				isApi: true,
				icon: 'https://icon2.cleanpng.com/20180330/jjq/avc3ltutu.webp',
			},
			{
				slug: 'lkifjwnjk2',
				href: 'https://www.packetwatch.co.uk',
				label: 'Packetwatch',
				isApi: false,
				icon: 'https://icon2.cleanpng.com/20180330/jjq/avc3ltutu.webp',
			},
		...
		<SidebarProvider>
			...
			<SidebarInset>
				...
				<main className="flex-1 p-4 md:p-6 lg:p-8 scroll-smooth space-y-6">
					{locations.data.length === 0 ? <OnboardingSteps /> : children}
				</main>
			</SidebarInset>
		</SidebarProvider>
	)
